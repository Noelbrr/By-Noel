...
const Logo = () => (
  <svg viewBox="0 0 500 500" className="w-24 h-24 md:w-32 md:h-32">
    <g transform="translate(37, 185)">
...
export default function App() {
  ...
  const scrollToContact = () => {
    scrollRef.current?.scrollTo("#contact-section", {
      duration: 2,
  ...
  return (
    <div ref={containerRef} data-scroll-container className="bg-black">
      <button
      ...
      <section id="contact-section" className="min-h-screen flex flex-col items-center justify-center px-6 py-24 bg-black">
